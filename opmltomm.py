...
input_opml_file='/Users/allandavies/Developer/Python/MyProjects/opmltomm/TestData/sample.opml'

# Full path to the output .mm which can be imported into Freemind 1.x or FreePlane 1.5.x
output_mm_file='/Users/allandavies/Developer/Python/MyProjects/opmltomm/TestData/sample.mm'
